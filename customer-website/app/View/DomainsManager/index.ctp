			...
			<div class="col-lg-12">
				...
				<div class="search_advance">
					...
					<div id="search" style="display: none;">
						...
						<?php echo $this->Form->create(false, array('url' => array('controller' => 'DomainsManager', 'action' => 'search'))); ?>
							<table class="table table-bordered" style="width: 80%;margin: auto;">
								<tbody>
									...
									<tr>
										<td>Loại Tên miền:</td>
										<td>
											<select name="domain_type" onchange="search(this.value,'domain_type');">
												<option selected="selected" value="">Chọn loại tên miền</option>
												<option value="0">Tên miền việt nam</option>
...
<script type="text/javascript">
	...
	function getOrderBy(value){
	 ...
	 $("#reg_date,#exp_date").datepicker();
	 function search(input,input_type){
	 	$.ajax({
	 		url: "<?php echo $this->Html->url(array('controller'=>'DomainsManager','action'=>'index')); ?>",
	 		type: 'POST',
	 		dataType: 'html',
